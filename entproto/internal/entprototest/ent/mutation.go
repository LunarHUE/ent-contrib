...
const (
	...
	TypeAutoFieldMessage         = "AutoFieldMessage"
...
// AutoFieldMessageMutation represents an operation that mutates the AutoFieldMessage nodes in the graph.
type AutoFieldMessageMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*AutoFieldMessage, error)
	predicates    []predicate.AutoFieldMessage
}

var _ ent.Mutation = (*AutoFieldMessageMutation)(nil)

// autofieldmessageOption allows management of the mutation configuration using functional options.
type autofieldmessageOption func(*AutoFieldMessageMutation)

// newAutoFieldMessageMutation creates new mutation for the AutoFieldMessage entity.
func newAutoFieldMessageMutation(c config, op Op, opts ...autofieldmessageOption) *AutoFieldMessageMutation {
	m := &AutoFieldMessageMutation{
		config:        c,
		op:            op,
		typ:           TypeAutoFieldMessage,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withAutoFieldMessageID sets the ID field of the mutation.
func withAutoFieldMessageID(id int) autofieldmessageOption {
	return func(m *AutoFieldMessageMutation) {
		var (
			err   error
			once  sync.Once
			value *AutoFieldMessage
		)
		m.oldValue = func(ctx context.Context) (*AutoFieldMessage, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().AutoFieldMessage.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withAutoFieldMessage sets the old AutoFieldMessage of the mutation.
func withAutoFieldMessage(node *AutoFieldMessage) autofieldmessageOption {
	return func(m *AutoFieldMessageMutation) {
		m.oldValue = func(context.Context) (*AutoFieldMessage, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m AutoFieldMessageMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m AutoFieldMessageMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *AutoFieldMessageMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *AutoFieldMessageMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().AutoFieldMessage.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *AutoFieldMessageMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *AutoFieldMessageMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the AutoFieldMessage entity.
// If the AutoFieldMessage object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AutoFieldMessageMutation) OldName(ctx context.Context) (v string, err error) {
...
func (m *AutoFieldMessageMutation) ResetName() {
	m.name = nil
}

// SetAge sets the "age" field.
func (m *AutoFieldMessageMutation) SetAge(i int32) {
	m.age = &i
	m.addage = nil
}

// Age returns the value of the "age" field in the mutation.
func (m *AutoFieldMessageMutation) Age() (r int32, exists bool) {
	v := m.age
	if v == nil {
		return
	}
...
// OldAge returns the old "age" field's value of the AutoFieldMessage entity.
// If the AutoFieldMessage object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AutoFieldMessageMutation) OldAge(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AutoFieldMessageMutation) AddAge(i int32) {
	if m.addage != nil {
		*m.addage += i
	} else {
		m.addage = &i
...
func (m *AutoFieldMessageMutation) AddedAge() (r int32, exists bool) {
	v := m.addage
	if v == nil {
		return
	}
...
func (m *AutoFieldMessageMutation) ResetAge() {
	m.age = nil
	m.addage = nil
}

// Where appends a list predicates to the AutoFieldMessageMutation builder.
func (m *AutoFieldMessageMutation) Where(ps ...predicate.AutoFieldMessage) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the AutoFieldMessageMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *AutoFieldMessageMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.AutoFieldMessage, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *AutoFieldMessageMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *AutoFieldMessageMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (AutoFieldMessage).
func (m *AutoFieldMessageMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *AutoFieldMessageMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.name != nil {
		fields = append(fields, autofieldmessage.FieldName)
	}
	if m.age != nil {
		fields = append(fields, autofieldmessage.FieldAge)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *AutoFieldMessageMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *AutoFieldMessageMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case autofieldmessage.FieldName:
	...
	return nil, fmt.Errorf("unknown AutoFieldMessage field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AutoFieldMessageMutation) SetField(name string, value ent.Value) error {
	switch name {
	case autofieldmessage.FieldName:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown AutoFieldMessage field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *AutoFieldMessageMutation) AddedFields() []string {
	var fields []string
	if m.addage != nil {
		fields = append(fields, autofieldmessage.FieldAge)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *AutoFieldMessageMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case autofieldmessage.FieldAge:
		return m.AddedAge()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AutoFieldMessageMutation) AddField(name string, value ent.Value) error {
	switch name {
	case autofieldmessage.FieldAge:
		v, ok := value.(int32)
		if !ok {
	...
	return fmt.Errorf("unknown AutoFieldMessage numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *AutoFieldMessageMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *AutoFieldMessageMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *AutoFieldMessageMutation) ClearField(name string) error {
	return fmt.Errorf("unknown AutoFieldMessage nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *AutoFieldMessageMutation) ResetField(name string) error {
	switch name {
	case autofieldmessage.FieldName:
		m.ResetName()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *AutoFieldMessageMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *AutoFieldMessageMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *AutoFieldMessageMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *AutoFieldMessageMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *AutoFieldMessageMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *AutoFieldMessageMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *AutoFieldMessageMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown AutoFieldMessage unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *AutoFieldMessageMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown AutoFieldMessage edge %s", name)
}
